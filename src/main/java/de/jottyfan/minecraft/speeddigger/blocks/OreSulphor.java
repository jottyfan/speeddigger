 ...
 *
 */
public class OreSulphor extends BlockOre {

	public OreSulphor(CreativeTabs tab) {
		super();
		super.setRegistryName(SpeedDigger.MODID, "oresulphor");
		super.setUnlocalizedName("oresulphor");
		super.setHardness(1.9f);
